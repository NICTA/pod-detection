...
public class TestAsgInstanceNumAssertion {
    @BeforeClass
    ...
    private class AssertionForTestWithAssignedCheckResult extends AsgInstanceNumAssertion {
    ...
    private class AssertionForTestWithTimeoutExceptionThrown extends AsgInstanceNumAssertion {
        public void join() {
            try {
                worker.join();
            } catch (InterruptedException ex) { }
    ...
    private class AssertionForTestWithInterruptedExceptionThrown extends AsgInstanceNumAssertion {
        public void join() {
            try {
                worker.join();
            } catch (InterruptedException ex) { }
    ...
    private class AssertionForTestWithCancellationExceptionThrown extends AsgInstanceNumAssertion {
        public void join() {
            try {
                worker.join();
            } catch (InterruptedException ex) { }
    ...
    private class AssertionForTestWithExecutionExceptionThrown extends AsgInstanceNumAssertion {
        public void join() {
            try {
                worker.join();
            } catch (InterruptedException ex) { }
    ...
    private class AssertionForTestWithAmazonClientExceptionThrown extends AsgInstanceNumAssertion {
        public void join() {
            try {
                worker.join();
            } catch (InterruptedException ex) { }
    ...
    private class AssertionForTestWithAmazonServiceExceptionThrown extends AsgInstanceNumAssertion {
        public void join() {
            try {
                worker.join();
            } catch (InterruptedException ex) { }
    ...
    private void setDefaultAssertionProperties(AsgInstanceNumAssertion assertion) {
